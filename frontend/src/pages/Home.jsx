...
// Class-based Intersection Observer Wrapper using InView render-prop API
class IntersectionWrapper extends Component {
  render() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="container mx-auto px-4 py-28">
          ...
          >
            <motion.h1 
              variants={slideUp} 
              className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-6"
            >
            ...
            <motion.div 
              variants={scaleUp} 
              className="mt-16 shadow-xl rounded-2xl overflow-hidden border border-gray-200"
            >
...
// Wrapper to inject navigation prop using useNavigate hook
